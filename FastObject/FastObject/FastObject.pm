...
our @EXPORT = qw(class has _internal_class_Dump inherite _INH_CLASS);
...
sub inherite {
	...
	$FastObject::_INH_CLASS = "$classname" unless $FastObject::_INH_CLASS;
	eval "require $inherited;";
	
	&{$FastObject::class_code{"$inherited"}};
